 ...
 *
 * This uses the folder-style catch-all (`[...path]/index.js`) which Vercel treats
 * differently from the single file form and (typically) forwards the full path.
 */
...
export default async function handler(req, res) {
  ...
  // req.url already includes `/api/accounts/...`
