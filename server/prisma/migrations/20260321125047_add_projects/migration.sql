...
-- AddForeignKey
ALTER TABLE "ProjectTask" ADD CONSTRAINT "ProjectTask_assigneeDirectorId_fkey" FOREIGN KEY ("assigneeDirectorId") REFERENCES "Director"("id") ON DELETE SET NULL ON UPDATE CASCADE;
